...
export const YouTubeCard: React.FC<YouTubeCardProps> = ({ data, onCardClick }) => {
  ...
  return (
    <BaseCard onClick={handleCardClick}>
      ...
      {/* Thumbnail */}
      <div className="relative mb-4 rounded-lg overflow-hidden bg-gray-800 flex-shrink-0">
            ...
            <>
              <img
                ...
                onError={(e) => {
                  ...
                  const fallback = target.parentElement?.querySelector('.fallback-container') as HTMLElement;
                  if (fallback) fallback.style.display = 'flex';
                }}
              />
              <div className="fallback-container hidden w-full h-full absolute inset-0 items-center justify-center text-gray-400 bg-gray-800">
